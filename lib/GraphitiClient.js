...
import { GraphitiModuleOps } from './graphiti/GraphitiModuleOps.js';
...
export class GraphitiClient {
  ...
  // Function operations (legacy — kept for backward compat)
  ...
  // Module operations (ast_ namespace — replaces function-level entities)
  upsertModule(...args) { return this._modules.upsertModule.apply(this._modules, args); }
  upsertModulesBatch(...args) { return this._modules.upsertModulesBatch.apply(this._modules, args); }
  createDependencyEdge(...args) { return this._modules.createDependencyEdge.apply(this._modules, args); }
  createDependencyEdgesBatch(...args) {
    return this._modules.createDependencyEdgesBatch.apply(this._modules, args);
  }
  syncModules(...args) { return this._modules.syncModules.apply(this._modules, args); }
...
export function createAstGraphitiClient(config, projectIdentifier) {
