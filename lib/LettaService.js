...
import { LettaConfig } from '../src/letta/LettaConfig.js';
import { LettaAgentPersistenceService } from '../src/letta/LettaAgentPersistenceService.js';
...
export class LettaService {
  ...
  async attachMcpTools(agentId) {
    return this._tools.attachMcpTools(agentId);
  }
  ...
  async _ensureTemplateBlocks(agentId, opts) {
    return this._memory._ensureTemplateBlocks(agentId, opts);
  }
