...
export class FileWatcher {
  constructor(lettaService, db, options = {}) {
    ...
    // State
    /** @type {Map<string, ProjectFileWatcher>} */
  ...
  watchProject(projectIdentifier, projectPath, folderId) {
    ...
    const watcher = /** @type {ProjectFileWatcher} */ (chokidar.watch(projectPath, {
  ...
  async handleFileUpdate(projectIdentifier, relativePath, fullPath, folderId) {
    ...
    const fileMetadata = /** @type {{ id: string }} */ (await uploadResponse.json());
