...
async function stageBeadsFiles(projectPath, files) {
...
async function commitStagedChanges(projectPath, commitMessage) {
 ...
 * @returns {Promise<string>} Parsed JSON output from the command
 */
 ...
 * @param {string[]} [issueData.labels] - Optional labels
