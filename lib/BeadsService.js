  ...
  if (storedParentHulyId !== currentParentHulyId) {
    ...
    if (storedParentHulyId) {
      ...
      if (oldParentDbIssue?.beads_issue_id) {
        ...
        console.log(`[Beads] ✓ Removed old parent dependency: ${beadsIssue.id} -> ${oldParentDbIssue.beads_issue_id}`);
      }
    }
    ...
    if (currentParentHulyId) {
      ...
      if (newParentDbIssue?.beads_issue_id) {
        ...
        console.log(`[Beads] ✓ Added new parent dependency: ${beadsIssue.id} -> ${newParentDbIssue.beads_issue_id}`);
