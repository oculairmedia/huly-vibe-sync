...
const vibeKanbanSchema = z
  .object({
    mcpUrl: z.string().optional(),
    apiUrl: z.string().optional(),
    useRestApi: z.boolean(),
  })
  .refine(data => data.apiUrl || data.mcpUrl, {
    message: 'VIBE_API_URL or VIBE_MCP_URL must be set',
  });
