...
async function getProjectIssuesWithBeadsFallback({ db, project, projectIdentifier, beadsAdapter, logger }) {
  ...
  try {
    const beadsResult = await beadsAdapter.listIssues(project, {}, { forceRefresh: true });
