...
export class HulyRestClient {
   ...
   * @param {boolean} options.fast - If true, skip sub-issue and parent handling for maximum speed
   * @param {number} options.concurrency - Number of parallel deletions (default 10, max 20)
