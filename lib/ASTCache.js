 ...
 * @typedef {import('./ASTParser.js').ImportInfo} ImportInfo
 * @typedef {import('./ASTParser.js').ClassInfo} ClassInfo
 * @typedef {import('./ASTParser.js').ExportInfo} ExportInfo
 */
...
export class ASTCache {
   ...
   * @param {ImportInfo[]} [imports=[]] - Extracted imports
   * @param {ClassInfo[]} [classes=[]] - Extracted classes
   * @param {ExportInfo[]} [exports=[]] - Extracted exports
   */
  set(filePath, contentHash, mtime, functions, imports = [], classes = [], exports = []) {
    if (!this.cache) {
      this.cache = this._createEmptyCache();
    }
